...
include_once 'classes/add-business.php';
session_start();
...
<html lang="en">
    ...
    <aside1>
       <h2>Go Back</h2>
       <div class="container">
				   <button class="btn btn-primary my-5"><a href="login.php" class="text-light">Return</button>
           </div></a>	
    ...
    <main>   
         <h2>Invite User</h2>	
          ...
          <form method="post">
           ...
           <div class="form-group">
				   	 <input type="email" class="form-control" placeholder="business Email" name="businessEmail">
				   </div>
				   <div class="form-group">
           ...
           <div class="form-group">
			...
			<div class="form-group">
				   	 <input type="text" class="form-control" placeholder="additional Locations" name="additionalLocations">
				   </div>
           </div>
