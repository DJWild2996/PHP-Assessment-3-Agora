...
if(isset($_POST['update'])){
  ...
  $sql= "update user set email='$email',userName='$userName',fistName='$firstName',lastName='$lastName',phoneNumber='$phone',passwordHash='$hashedPwd',dateOfBirth='$DOB' where userID=61";
