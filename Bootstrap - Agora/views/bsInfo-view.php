<?php
  $sql = "select distinct(businessName), businessEmail, businessPhone, businessInfo, concat(streetNumber, ' ', streetName, ' ', suburb, ' ', city, ' ', postcode) as 'Location', additionalLocations, imagePath from business where businessID = 1 ";
